...
import datalayer.datamappers.userskill.IUserSkillMapper;
...
public class UserMapperTest {
    ...
    private IUserSkillMapper userSkillMapper;
...
//        User newUser = userMapper.save(new User(UUID.randomUUID().toString(), "Ali", "a", "taba", "bikar", "www.google.com", "delesh pizza pepperoni baghaliashuno mikhad"));
        UserSkill newUser = userSkillMapper.save(new UserSkill());
